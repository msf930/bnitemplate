                    ...
                    <div className="flex flex-row items-center w-full gap-6 rounded-[32px]">
                        ...
                        <div>
                            {member?.image?.asset?.url ? (
                                <div className="w-[7vw] h-[7vw] relative bg-gray-200 rounded-4xl flex items-center justify-center text-gray-500">
                                    <Image
                                ...
                                <div className="w-[7vw] h-[7vw] relative bg-white rounded-4xl flex items-center justify-center text-gray-500">
                                    <Image
                                        src="/360logoRed.png"
                                        alt="BNI 360 Logo"
                                        fill
                        ...
                        <div className="grid grid-rows-2 items-center justify-start gap-1 w-full h-[6vw]">
